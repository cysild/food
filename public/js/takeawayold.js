    ...
    $.extend(Takeaway.prototype, {
        ...
        _setToolbar: function () {
            ...
            if (this.options.toolbarSettings.showCartSummary) {
                ...
                panelSubTotal.append('<select class="form-control" id="members" name="member"></select>')
       ...
       //     this._getmytotal();
        ...
        //   alert(mi._getCartSubtotal());
         ...
         var mysel =   $('#members').find(":selected").val();


if(mysel){
if(mysel != 0){
    if(mi._getCartSubtotal() > 0){
      var total = mi._getCartSubtotal() * mysel;
 ...
 // $('#members').val(0);
  ...
  $("#members option[value='0']").attr("selected", "selected");
     ...
     $('#total').html('');
              ...
              $("#takeaway").on("change", "select[id=members]", function() {
         ...
         //     alert(mi._getCartSubtotal());
               var total = mi._getCartSubtotal() * $(this).val();
