 <div class="modal fade" id="modal-add">
             ...
             <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{$page['save_url']}}" id="add-data" >
                <div class="form-group">
                    <label for="name_en" class=" col-md-2">Minimum Value:</label>
                    <div class=" col-md-10">
                       <input type="text" class="form-control" name="starting_value" value="" >
                    </div>           
                </div>
                <div class="form-group">
                    <label for="name_en" class=" col-md-2">Maximum Value:</label>
                    <div class=" col-md-10">
                       <input type="text" class="form-control" name="ending_value" value="" >
                    </div>           
                </div>
                 <div class="form-group">
                    <label for="name_en" class=" col-md-2"> Pax Value:</label>
                    <div class=" col-md-10">
