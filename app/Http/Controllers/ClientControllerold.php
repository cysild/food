...
function pointindex()
    {
      $heading  = ['id','number of pax','value','status','action'];
                ...
                ->addColumn('status',function ($data)
{
        ...
        ->make(true);
         ...
         function pointstore(Request $request){
             ...
             $validator = Validator::make($request->all(), [
                'member_range' => 'required|nullable',
                'point_value' => 'required|nullable',
                ],
                [
                 'member_range.required' => 'Member Range Required',
                 'point_value.required'=>'Points Value Required',
                 'member_range.nullable' => 'Member Range Required',
                 'point_value.nullable'=>'Points Value Required',
                ...
                $member->member_count=$request->member_range;
